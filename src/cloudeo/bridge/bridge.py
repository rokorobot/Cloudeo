...
def bridge_instructions(run_id: str, task: str) -> str:
    ...
    return (
        ...
        "  2. The project snapshot is now authoritative. If the project contains an\n"
        "     instruction file such as AGENTS.md, CLAUDE.md, QWEN.md or GEMINI.md,\n"
        "     read it now and follow its project instructions for the task.\n"
        "  3. Work only on that extracted project, in the current working directory.\n"
